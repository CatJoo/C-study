...
int main_file(void)
{
	...
	// 파일에 쓰기
	/*FILE* file = fopen("test1.txt", "wb");  //r 읽기전용 w 쓰기전용 a 이어쓰기 , t 텍스트 b 바이널데이터 //fopen 살짝 문제 발생할수도...
...
//fprintf, fscanf 쌍  --> 정형화된 포맷에 대해 파일을 다루고 싶을때, 문자열도 가능
